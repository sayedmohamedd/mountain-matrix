...
const page = () => {
  return (
    <>
      <header
        className={`h-[70vh] flex justify-center items-center  py-20 bg-center bg-no-repeat bg-cover`}
        style={{ backgroundImage: "url('/about-cover.jpeg')" }}
      >
        <div className="container text-white  text-center bg-gray-300 opacity-90">
          <h2 className="text-4xl font-bold my-5">About Mountains Solutions</h2>
